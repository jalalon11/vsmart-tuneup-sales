                ...
                <div class="sm:flex sm:items-start">
                    <div class="w-full">
                        <div class="mb-8 border-b dark:border-gray-700 pb-4">
                            <h3 class="text-2xl font-bold text-gray-900 dark:text-white" id="modal-title">Add New Item</h3>
                            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Fill in the item details to add it to your inventory.</p>
                        </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <input type="number" name="reorder_point" id="reorder_point" min="0" required
                                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                                    </div>
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <div class="mt-1 relative rounded-md shadow-sm">
                                            ...
                                            <input type="number" name="selling_price" id="selling_price" min="0" step="0.01" required
                                                class="pl-7 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                                        </div>
                                    </div>
                                </div>
