                ...
                <div class="p-6">
                    ...
                    <div class="flex flex-col">
                        <div class="flex items-baseline">
                            <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $pendingRepairs ?? 0 }}</p>
                ...
                <div class="p-6">
                    ...
                    <div class="flex flex-col">
                        <div class="flex items-baseline">
                            ...
                            <p class="ml-2 text-sm text-gray-500 dark:text-gray-400">items</p>
                        </div>
                        <p class="text-sm font-medium text-gray-600 dark:text-gray-300 mt-1">Low Stock Items</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                ...
                <div class="flex items-baseline space-x-2">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400" id="weekRange"></p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                ...
                <div class="flex items-baseline space-x-2">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ $selectedMonth ?? now()->format('F Y') }}</p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                ...
                <div class="flex items-baseline space-x-2">
                    ...
                    <p class="text-sm text-gray-500 dark:text-gray-400">{{ $selectedYear ?? now()->year }}</p>
                </div>
            </div>
        </div>
